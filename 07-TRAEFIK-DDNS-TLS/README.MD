...
- Try to access your Traefik dashboard. [https://homelab-traefik.<your_domain>/](https://homelab-traefik.<your_domain>/). This attemp won't be able to open the dashboard, as we need to set up the TLS certificate.
