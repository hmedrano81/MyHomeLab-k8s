...
- Traefik Port Forward. Go to `Configuration` > `Policy Engine` > `Create a New Policy`.

  <img src="images/image-79.png" alt="drawing" width="1000"/>
...
- If it fails to deploy, run this command
